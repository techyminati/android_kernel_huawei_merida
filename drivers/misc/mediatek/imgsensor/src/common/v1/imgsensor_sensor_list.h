...
UINT32 OV02A10_FOXCONN_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
/*S5K*/
...
UINT32 S5K5E8YXREAR2_MIPI_RAW_SensorInit
	(struct SENSOR_FUNCTION_STRUCT **pfFunc);
UINT32 S5K4H7_TRULY_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
UINT32 S5K3L6_LITEON_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
UINT32 S5K3L6_TRULY_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
UINT32 S5K5E9YX_BYD_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
/*HI*/
...
UINT32 HI1336_QTECH_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
UINT32 HI846_LUXVISIONS_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
...
UINT32 GC8054_BYD_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
UINT32 GC2375_SUNNY_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
...
UINT32 BF2253MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);

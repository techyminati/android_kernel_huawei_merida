...
#define SENSOR_TYPE_HW_MOTION                          73
/* end sensor type */
#define SENSOR_TYPE_MAX_NUM                            SENSOR_TYPE_HW_MOTION
...
/*follow huawei  add sensor ID*/
#define ID_HW_MOTION                  (ID_BASE + SENSOR_TYPE_HW_MOTION - 1)
/* end sensor ID */
#define ID_SENSOR_MAX_HANDLE    (ID_HW_MOTION)
